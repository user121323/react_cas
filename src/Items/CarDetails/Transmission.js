...
function Transmission(){
    ...
    async function loadData(){
        const responseRegion = await fetch("http://localhost:8081/api/carTransmission/getAllCarTransmission",{
            method:"GET",
            headers:{
    ...
    async function createBody(data){
        console.log(data)
        const response = await fetch("http://localhost:8081/api/carTransmission/addCarTransmission",{
            method:"POST",
            mode:"cors",
            cache:"no-cache",
    ...
    async function editBody(data){
        console.log(data)
        const response = await fetch("http://localhost:8081/api/carTransmission/saveCarTransmission",{
            method:"PUT",
            mode:"cors",
            cache:"no-cache",
            credentials:"same-origin",
    ...
    async function deleteBody(data){
        console.log(data)
        const response = await fetch("http://localhost:8081/api/carTransmission/deleteCarTransmission",{
            method:"DELETE",
            mode:"cors",
            cache:"no-cache",
            credentials:"same-origin",
    ...
    return(<div className="mt-5">
        <Container>
            <Row className="justify-content-center">
                <Button variant="primary" onClick={handleShowCreate}>Create Transmission</Button>
                    ...
                    <Form onSubmit={handleCreateBody}>
                        <Modal.Body>
                            <Form.Group controlId="formBasicPassword">
                                ...
                                <Form.Control type="text" placeholder="Transmission" value={newBodyName} onChange={handleChangeNewBodyName}/>
                            </Form.Group>
                        </Modal.Body>
                        <Modal.Footer>
            ...
            <Modal show={showEdit} onHide={handleCloseEdit}>
                <Modal.Header closeButton>
                    <Modal.Title>Car Transmission</Modal.Title>
                </Modal.Header>
                ...
                <Form onSubmit={handleEditBody}>
                    <Modal.Body>
                        <Form.Group controlId="formBasicPassword">
                            <Form.Label>Transmission Name</Form.Label>
                            <Form.Control type="text" placeholder="Transmission" value={editBodyName} onChange={handleChangeEditBodyName}/>
                        </Form.Group>
                    </Modal.Body>
                    <Modal.Footer>
            ...
            <Modal show={showDelete} onHide={handleCloseDelete}>
                <Modal.Header closeButton>
                    <Modal.Title>Delete Transmission</Modal.Title>
                </Modal.Header>
